...
<html lang="ja"><head>
<meta charset="utf-8">
<title>新規動画登録確認｜Admin Tool</title>
<meta name="description" content="管理画面ツール　新規動画登録確認">
...
<div class="page_base_in">
  ...
  <div class="page_base_box">
    ...
    <p>
    <label><span>Vimeo URL（<font color="#CC0000">必須</font>）</span><?php echo $profinfo1; ?></label>
    </p>
    <p>
    <label><span>タイトル（<font color="#CC0000">必須</font>）</span><?php echo $comment2; ?><input name="name2" type="hidden" class="w_per50" value="<?php echo $name2; ?>" /></label>
    </p>
    <p>
...
?>
    ...
    <p>
    <label><span>コメント（<font color="#CC0000">必須</font>）</span><?php echo $comment; ?></label>
    </p> 
...
?>
      ...
      <div class="todayscast_button_2"><input type="hidden" name="name" value="<?php echo $name; ?>" />
